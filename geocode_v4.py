...
poverty_census_tracts = {tract[-6:] for tract in poverty_tracts}
poverty_counties = {tract[-9:-6] for tract in poverty_tracts} # county code of the poverty tract, doesn't mean the county itself is in poverty
...
for row in results:
    ...
    if tract_code in poverty_census_tracts:
        print("This tract IS in a persistent poverty area.")
    else:
        print("This tract is NOT in a persistent poverty area.")
    if county_code in poverty_counties:
        print("This county IS in a persistent poverty area.\n")
    else:
        print("This county is NOT in a persistent poverty area.\n")
